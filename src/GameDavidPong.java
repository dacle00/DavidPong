...
public class GameDavidPong extends Applet implements Runnable, KeyListener
{
	...
	int			INITIALPADDLE1X;
	int			INITIALPADDLE2X;
	final int	INITIALBALLXSPEED = 2;
	final int	INITIALBALLYSPEED = 1;
	final int	BALLXSPEEDMAX = PADDLEWIDTH-2;
	final int	BALLXSPEEDMIN = 1;
	final int	INITIALBALLRADIUS = 8;
	final int	MAXBALLPAUSE = 120;
	int			ballPauseCountdown;
